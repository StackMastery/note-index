      ...
      <AnimatePresence>
        {isVideoOpen && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[9999999999999999999] flex items-center justify-center bg-black/50 backdrop-blur-md"
          >
            <motion.div
              {...selectedAnimation}
            ...
            >
              <motion.button className="absolute -top-16 right-0 rounded-lg bg-slate-900/50 p-2 text-xl text-white ring-1 backdrop-blur-md dark:bg-neutral-100/50 dark:text-black">
                <XIcon className="size-5" />
              </motion.button>
              <div className="relative isolate z-[1] size-full overflow-hidden rounded-2xl border-4 border-slate-700">
                <iframe
                  src={videoSrc}
